        ...
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-background/80">
              <li>
                <a href="tel:+14256831611" className="hover:text-background transition-colors">
                  +14256831611
                </a>
              </li>
              <li>
                <a href="mailto:magada19@icloud.com" className="hover:text-background transition-colors">
                  magada19@icloud.com
                </a>
              </li>
